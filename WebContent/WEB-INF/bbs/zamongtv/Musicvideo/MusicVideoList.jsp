...
<!-- contents -->
	...
	<li class="vdo_li04 " >
			<div class="wrap_video04">
				<a href="javascript:melon.link.goMvDetail('60050000', '50173132', 'video', 'MV0001')" class="thumb">
				...
				<dl>
					<dt>
						<span class="vdo_title">
							<span>
								...
								<a href="javascript:melon.link.goMvDetail('60050000', '50173132', 'video', 'MV0001')" title="Stan Lee (Feat. 니화, DJ DREV) - 페이지 이동">${item.mv_title}</a>
					...
					<dd class="atistname">
						...
						<div class="ellipsis">
							<a href="javascript:melon.link.goArtistDetail('1956612');" title="${item.at_no} - 페이지 이동">${item.at_no}</a><span class="checkEllipsisTypeFourRight" style="display:none"><a href="javascript:melon.link.goArtistDetail('1956612');" title="${item.at_no} - 페이지 이동">${item.at_no}</a></span>
						</div>
