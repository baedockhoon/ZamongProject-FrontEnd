 ...
 */
	 ...
	 */
							...
							</script><div class="logout_wrap"><div class="mem_info"><strong><a href="<c:url value='/ZamongFrontEnd/MemberDetail.do'/>">${me_id }</a>님</strong><a href="https://www.melon.com/muid/web/help/myinfointro_inform.htm" title="내정보" class="bg_none"><span>내정보</span></a><div class="mem_btn" id="d_facebook_mem_btn"><button type="button" class="btn_info sns_facebook" title="페이스북 연동하기" onclick="goConnectSns();"><span>페이스북 연동하기</span></button></div><a href="javascript:MELON.WEBSVC.POC.login.gnbLogout();" onclick="MELON.WEBSVC.POC.login.gnbLogout();" title="로그아웃" class="btn_logout"><span>로그아웃</span></a></div><span class="btn_buy"><a href="javascript:melon.menu.cm.goPamphlet();" title="이용권구매">이용권구매</a></span><div class="mem_used"><strong class="product_name">보유중인 이용권이 없습니다.</strong><ul><li class="nth1"><a href="javascript:melon.link.goMyCupon();"><span><span class="label">쿠폰</span><span class="nm">0</span></span></a></li><li class="nth2"><a href="javascript:melon.link.goMelonCash();"><span><span class="label">캐쉬</span><span class="nm">0</span></span></a></li><li class="nth3"><a href="javascript:melon.link.goPresentSong();"><span><span class="label">선물</span><span class="nm">0</span></span></a></li></ul></div></div>
