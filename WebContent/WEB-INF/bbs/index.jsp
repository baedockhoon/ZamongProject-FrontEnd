...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/ZamongFrontEnd/styles/css/14g2jf0vkd.css" type="text/css" />
	<script type="text/javascript">
	(function() {
		WEBPOCIMG = {
	...
	<div id="header" class="main">
		...
		<div id="header_wrap" class="pr_none">  <!-- 메인 컨텐츠 가운데 정렬을 위한 pr_none 클래스 추가 -->
			<div id="gnb" class="clfix">
				...
				<!-- 140603_수정 -->
				<h1><a href="${pageContext.request.contextPath}/mellon/manu/Index.jsp" title="MelOn 로고 - 홈으로 이동" class="mlog" data="LOG_PRT_CODE=1&MENU_PRT_CODE=0&MENU_ID_LV1=&CLICK_AREA_PRT_CODE=M01&ACTION_AF_CLICK=V1"><img width="142" height="99" src="http://cdnimg.melon.co.kr/resource/image/web/common/logo_melon142x99.png" alt="MelOn 로고 이미지"/></a></h1>
			...
			<div id="gnb_menu">
				<ul>
					...
					<li class="nth5">
						...
						<a href="http://www.melon.com/tv/index.htm" class="cur_menu mlog" data="LOG_PRT_CODE=1&MENU_PRT_CODE=0&MENU_ID_LV1=&CLICK_AREA_PRT_CODE=S05&ACTION_AF_CLICK=V1"><span class="cur_status none">현재 선택된 메뉴-</span><span class="menu_bg menu05">매거진</span></a>
					</li>
					<li class="nth6">
						
						<a href="http://www.melon.com/artistplus/todayupdate/index.htm" class="cur_menu mlog" data="LOG_PRT_CODE=1&MENU_PRT_CODE=0&MENU_ID_LV1=&CLICK_AREA_PRT_CODE=S07&ACTION_AF_CLICK=V1"><span class="cur_status none">현재 선택된 메뉴-</span><span class="menu_bg menu06">뮤직어워드</span></a>
					</li>
					<!-- 160314 수정 -->
					<li class="nth7">
