			...
			<div id="gnb_menu">
				<ul>
					...
					<li class="nth2">
						...
						<a href="<c:url value="ZamongFrontEnd/SoundList.do" />" class="cur_menu mlog" data="LOG_PRT_CODE=1&MENU_PRT_CODE=0&MENU_ID_LV1=&CLICK_AREA_PRT_CODE=C01&ACTION_AF_CLICK=V1"><span class="cur_status none">현재 선택된 메뉴-</span><span class="menu_bg menu02 ">최신</span></a>
					</li>
					<li class="nth3">
					...
					<li class="nth5">
						...
						<a href="<c:url value='/ZamongFrontEnd/Magazine.do'/>" class="cur_menu mlog" data="LOG_PRT_CODE=1&MENU_PRT_CODE=0&MENU_ID_LV1=&CLICK_AREA_PRT_CODE=S05&ACTION_AF_CLICK=V1"><span class="cur_status none">현재 선택된 메뉴-</span><span class="menu_bg menu05">매거진</span></a>
					</li>
					<li class="nth6">
